...
em uma tupla, o **kwargs exige que utilizemos parãmetros nomeados, e transforma esses
...
# Funções com a ordem incorreta de parâmetros
...
# OBS! Os nomes da chave em um dicionário devem ser o mesmo dos parâmetros da funlção
