...
print(exponencial(3, 5))  # Eleva ã poténcia informada pelo usuário

# OBS
# Se o usuário passar somente 1 parâmetro, este será atribuído ao parâmetro numero,
# e será calculado o quadrado deste número;
# Se o usuário passar 2 argumentos, o primeiro será atribuido ao parâmetro numero e o segundo
# ao parâmetro potencia. Então será calculada esta poténcia.
...
# Quais tipos de dados podemos utilizar como valores default para parãmetros?

- Qualquer tipo de dados:
    - Numeros, strings, floats, booleans, listas, tuplas, dicionários, funçoes e etc
