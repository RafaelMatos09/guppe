...
O grande objetivo da POO é encapsular nosso código dentro de um grupo lógico e híerárquico utilizando
classes.
...
imagine que temos uma classe chamnada Pessoa, contendo
...
Abstraçãom en POO, é o ato de expor apenas dados relevantes de uma classe, escondendo
