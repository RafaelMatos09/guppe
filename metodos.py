...
Em Python, dividimos os métodos, assim como os atributos, em 2 grupos: Métodos de instancia
e Métodos de Classe.
...
não é aconselhado. Python possuir vários métodos com esta forma de nomenclatura e pode ser que mudemos o comportamento
dessas funções mágicas internas da linguagem. Então, evite ao máximo. De preferência não o faça.

# Métodos são escritos em letras minúsculas. Se o nome for composto, o nome terá underline
...
user2 = Usuario('Felicity', 'Jones', 'felicity@gmail.com', '6574844')

print(user1.nome_completo())

print(user2.nome_completo())

print(f'Senha User 1: {user1.__Usuario__senha}')  # Acesso de forma errada de um atributo de classe
print(f'Senha User 2: {user2.__Usuario__senha}')  # Acesso de forma errada de um atributo de classe
...
class Lampada:
    def __init__(self, cor, voltagem, luminosidade):
        ...
        self.__luminosidaded =luminosidade
        self.__ligada = False
