...
# OBS: Aassim como na função map(), após serem utilizados de filter() eles são
...
# filter() -> Recebe dois parâmetros, uma função e um iterável e retorna um objeto filtrado apenas os
# elementos de acaordo com a função
