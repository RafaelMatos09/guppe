...
Em POO, Classes nada mais são do que modelos dos objetos do mundoreal sendo representados
computacionalmente.
...
Classes podem conter:
    - Atributos -> Representam as caracteristicas do objeto. Ou seja, pelos atributos
      conseguimos representar computacialmente os estados de um objeto. No caso da lámpada, possivelmente
      iriamos qureer saber se a lámpada é 110 ou 220 volts, se ela é branca, amarela, vermelha ou outra cor, qual é a luminosidade
      dela e etc.

    - Métodos (funções) -> Representam os comportamentos do objeto. Ou seja as ações que este
    objeto pode realizar no seu sistema. No caso da lámpada, por exemplo, um comportamento comum
