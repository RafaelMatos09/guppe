...
de um função. Podemos passar a execução da função para outras funções.

# Vamos refatorar(redefinir) esta função para que ela retorne o valor
...
# Exemplo 3 - Podemos em uma função, retornar qualquer tipo de dado e até mesmo mútiplos valores;
